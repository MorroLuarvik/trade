...
```
```SQL
update c_requests set complete = 1 where req_id in (39291, 39373, 39413);
update c_request_error set is_closed = 1, close_ts = NOW() where error_id in (1898, 1903, 1906);
```
